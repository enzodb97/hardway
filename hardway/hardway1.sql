...
--
INSERT INTO
  `motivo_cancelacion` (`idMotivo`, `descripcion`)
VALUES
...
VALUES
  ...
  (
    'MOV-CANC-1751396519802-omh58',
    'STK006',
    '2025-07-01',
    2,
    'Devolución por cancelación de pedido PED-2025-407'
  ),
  (
    'MOV-CANC-1751396519809-7u66q',
    'STK001',
    '2025-07-01',
    2,
    'Devolución por cancelación de pedido PED-2025-407'
  ...
  (
    'MOV-CANC-1751414082038-ool4c',
    'STK001',
    '2025-07-01',
    3,
    'Devolución por cancelación de pedido PED-2025-747'
  ),
  (
    'MOV-CANCEL-343967',
    'STK039',
    '2025-06-20',
    2,
    'Devolución por cancelación de pedido PED-2025-521'
  ),
  (
    'MOV-CANCEL-379834',
    'STK003',
    '2025-06-20',
    2,
    'Devolución por cancelación de pedido PED-2025-708'
  ),
  (
    'MOV-CANCEL-717261',
    'STK039',
  ...
  (
    ...
    '2025-06-19',
    3,
    'Devolución por borrado de pedido PED-2025-317'
  ),
  (
    'MOV-DEL-317B',
    'STK003',
  ...
  (
    'MOV-EDIT-DESC-013982',
    'STK001',
    '2025-06-20',
    -2,
    'Descuento por edición de pedido PED-2025-521'
  ),
  (
    'MOV-EDIT-DESC-016961',
    'STK001',
    '2025-07-01',
    -3,
    'Descuento por edición de pedido PED-2025-747'
  ),
  (
    'MOV-EDIT-DESC-044093',
    'STK002',
    '2025-07-01',
    -4,
    'Descuento por edición de pedido PED-2025-747'
  ...
  (
    'MOV-EDIT-DESC-134413',
    'STK003',
    '2025-06-20',
    -2,
    'Descuento por edición de pedido PED-2025-407'
  ),
  (
    'MOV-EDIT-DESC-139546',
    'STK039',
    '2025-07-01',
    -2,
    'Descuento por edición de pedido PED-2025-521'
  ...
  (
    'MOV-EDIT-DESC-160539',
    'STK003',
    '2025-06-20',
    -2,
    'Descuento por edición de pedido PED-2025-708'
  ),
  (
  ...
  (
    ...
    '2025-07-01',
    3,
    'Devolución por edición de pedido PED-2025-747'
  ),
  (
    'MOV-EDIT-DEV-028788',
    'STK001',
  ...
  (
    ...
    '2025-06-20',
    2,
    'Devolución por edición de pedido PED-2025-407'
  ),
  (
    'MOV-EDIT-DEV-124081',
    'STK005',
  ...
  (
    ...
    '2025-06-20',
    2,
    'Devolución por edición de pedido PED-2025-521'
  ),
  (
    'MOV-EDIT-DEV-216002',
    'STK005',
  ...
  (
    ...
    '2025-06-20',
    2,
    'Devolución por edición de pedido PED-2025-708'
  ),
  (
    'MOV-EDIT-DEV-532693',
    'STK039',
  ...
  (
    ...
    '2025-06-20',
    -2,
    'Descuento por pedido PED-2025-708'
  ),
  (
    'MOV-PED-183627',
    'STK001',
  ...
  (
    ...
    '2025-06-20',
    -2,
    'Descuento por pedido PED-2025-521'
  ),
  (
    'MOV-PED-409936',
    'STK001',
  ...
  (
    ...
    '2025-07-01',
    -3,
    'Descuento por pedido PED-2025-747'
  ),
  (
    'MOV-PED-645037',
    'STK005',
...
--
ALTER TABLE `motivo_cancelacion` ADD PRIMARY KEY (`idMotivo`);
...
--
ALTER TABLE `motivo_cancelacion` MODIFY `idMotivo` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 7;
...
--
ALTER TABLE `pedido` ADD CONSTRAINT `fk_pedido_motivo_cancelacion` FOREIGN KEY (`idMotivoCancelacion`) REFERENCES `motivo_cancelacion` (`idMotivo`),
